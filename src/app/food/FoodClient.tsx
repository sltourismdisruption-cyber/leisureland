...
import type { FoodQuery } from "../../../tina/__generated__/types";

/*
  Phase 3 (TinaCMS): all IMAGES come from content/pages/food.json via useTina
  (editable click-on-the-page). The TEXT and the botanical SVG stay in code.
  Kept deliberately sparse — only the fruit showcase + CTA are filled; the rest
  are clean placeholders awaiting a dedicated food shoot (see PHOTOS_NEEDED.md).
*/

export default function FoodClient(props: {
  data: FoodQuery;
  query: string;
  variables: object;
}) {
        ...
        <div className="wrap">
          ...
          <div className="pair">
            <div className="pitem rv">
              <Shot tone="food" label="the spicy plate, portrait" src={d.spicyPlate ?? undefined} tinaField={tinaField(d, "spicyPlate")} />
              <div className="cap">
            ...
            <div className="pitem rv" style={{ transitionDelay: "90ms" }}>
              <Shot tone="gold" label="the mild plate, portrait" src={d.mildPlate ?? undefined} tinaField={tinaField(d, "mildPlate")} />
              <div className="cap">
      ...
      <section id="buffet">
        <div className="wrap">
          ...
          <div className="buf-hero rv">
            <Shot tone="food" label="the buffet spread, wide, steam and all" src={d.buffetSpread ?? undefined} tinaField={tinaField(d, "buffetSpread")} />
          </div>
        ...
        <div className="wrap">
          ...
          <div className="show">
            <div className="showc rv">
              <Shot tone="food" label="buffet ritual, plates being filled" src={d.showcase?.[0] ?? undefined} tinaField={tinaField(d, "showcase", 0)} />
              <div className="cap">
            ...
            <div className="showc rv" style={{ transitionDelay: "90ms" }}>
              <Shot tone="gold" label="evening tea at golden hour" src={d.showcase?.[1] ?? undefined} tinaField={tinaField(d, "showcase", 1)} />
              <div className="cap">
            ...
            <div className="showc rv" style={{ transitionDelay: "180ms" }}>
              <Shot tone="jungle" label="fruit straight off the tree" src={d.showcase?.[2] ?? undefined} tinaField={tinaField(d, "showcase", 2)} />
              <div className="cap">
